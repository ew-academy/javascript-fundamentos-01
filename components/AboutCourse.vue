<template>
  <section class="section AboutCourse">
    <div class="container AboutCourseContainer">
      ...
      <br>
      <p>
        Este treinamento foi  <strong>desenvolvido</strong>  sob medida  <strong>baseado</strong>  em uma pesquisa sobre o que a  <strong>comunidade brasileira mais necessita</strong>, suas principais  <strong>dificuldades</strong>  e  <strong>desafios</strong>. Neste curso você aprenderá desde o básico de Javascript, ciclo de vida, variáveis, tipos de dados, manipulação de listas à uma aplicação real. Ao fim do curso você receberá um belo certificado e terá acesso direto ao instrutor via nosso grupo oficial no facebook.
      </p>
      <br>
      <p>
